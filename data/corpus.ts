...
export const SIMULATORS: SimulatorMeta[] = [
  ...
  },
  {
    ...
    description:
      'F = P(1+i)ⁿ — sweep present worth, interest rate, and periods to watch compound growth and compute uniform annual equivalents.',
...
export const FORMULA_CARDS: FormulaCard[] = [
  ...
  {
    id: 'fc-uniform-series',
    topicId: 'econ-time-value',
    title: 'Uniform series compound amount',
    expression: 'F = A [(1+i)^n − 1] / i',
    latex: String.raw`F = A\,\frac{(1+i)^n - 1}{i}`,
    variables: [
      { symbol: 'A', name: 'uniform end-of-period payment', units: '$' },
      { symbol: 'i', name: 'interest rate per period', units: '—' },
      { symbol: 'n', name: 'number of periods', units: '—' },
    ],
    handbookSection: 'Engineering Economics',
  },
  {
    ...
    variables: [
      { symbol: 'A', name: 'annual equivalent', units: '$' },
      { symbol: 'P', name: 'present worth', units: '$' },
    ],
    handbookSection: 'Engineering Economics',
  },
...
export const QUIZ_ITEMS: QuizItem[] = [
  ...
  },
  {
    id: 'q-econ-1',
    topicId: 'econ-time-value',
    question: '$1,000 at 6% annual interest for 10 years gives a future worth closest to:',
    choices: ['$1,600', '$1,791', '$2,000', '$1,060'],
    correctIndex: 1,
  ...
  },
  {
    id: 'q-econ-2',
    topicId: 'econ-time-value',
    question: 'Doubling the interest rate i (holding P and n fixed) will:',
    choices: [
      'Exactly double F',
      'More than double F for n > 1',
      'Have no effect',
      'Halve F',
    ],
    correctIndex: 1,
    explanation: 'F = P(1+i)^n is convex in i for n > 1, so doubling i more than doubles F.',
  },
  {
    id: 'q-econ-3',
    topicId: 'econ-time-value',
    question: 'The present worth factor (P/F, i, n) equals:',
    choices: ['(1+i)^n', '1/(1+i)^n', 'i(1+i)^n', '[(1+i)^n − 1]/i'],
    correctIndex: 1,
    explanation: 'P = F/(1+i)^n, so the factor is 1/(1+i)^n.',
  },
  {
    id: 'q-econ-4',
    topicId: 'econ-time-value',
    question: 'As n → ∞ at fixed positive i, the uniform-series present-worth factor (P/A) approaches:',
    choices: ['0', '1/i', 'i', '∞'],
    correctIndex: 1,
    explanation: '(P/A) = [(1+i)^n − 1] / [i(1+i)^n] → 1/i as n → ∞ (perpetuity formula).',
  },
  {
    id: 'q-econ-5',
    topicId: 'econ-time-value',
    question: 'If a project costs $5,000 now and returns $800/yr for 10 years at 8%, the NPW is closest to:',
    choices: ['$368', '−$368', '$3,000', '−$5,000'],
    correctIndex: 0,
    explanation: 'NPW = −5000 + 800 × (P/A, 8%, 10) = −5000 + 800 × 6.7101 ≈ 368.',
  },
  {
    id: 'q-ctrl-5',
    topicId: 'control-second-order',
...
Use your NCEES PDF for the exact conversion blocks.`,
  ...
  },
  {
    ...
    pageHint: 230,
    learningObjectives: [
      'Compute F from P using single-payment compound amount factor',
      'Relate uniform annual series A to present worth P',
      'Recognize how compounding accelerates growth at higher i or n',
    ],
    lesson: `Engineering economics on the FE exam boils down to moving cash flows through time. The compound amount factor (F/P) = (1+i)ⁿ converts a present sum to a future value. Its reciprocal (P/F) discounts future cash to today.

Uniform series factors (A/P, P/A, A/F, F/A) convert between lump sums and equal annual payments. The capital recovery factor A/P = i(1+i)ⁿ / [(1+i)ⁿ − 1] is the basis for loan payments.

Use the playground to sweep i and n; watch how the curve bends more steeply as either grows—this is the power of compounding that drives most FE economics items.`,
    formulaCardIds: ['fc-fv-compound', 'fc-uniform-series', 'fc-cap-recovery'],
    quizItemIds: ['q-econ-1', 'q-econ-2', 'q-econ-3', 'q-econ-4', 'q-econ-5'],
    simulatorIds: ['econ-time-value'],
  },
  {
    id: 'econ-preview',
    sectionId: 'economics',
    title: 'Engineering economics — additional topics',
    handbookSection: 'Engineering Economics',
    pageHint: 230,
    learningObjectives: ['Benefit/cost analysis and depreciation methods'],
    lesson: `Placeholder: expand with benefit/cost ratio, rate-of-return analysis, and depreciation methods from your handbook.`,
    formulaCardIds: [],
    quizItemIds: [],
    simulatorIds: [],
  },
